...
if (!isset($_SESSION['paiement-num'])) {
...
$num=$_SESSION['paiement-num'];
$somme=$_SESSION['paiement-somme'];
$chacun=round(100*$somme/$num)/100;
...
for ($i=0; $i<$num; $i++) {
  ...
  $cancel.=",".$id.",".$chacun;
  if ($i!=$num-1) $listevariations.=", ";
}
//echo "debug: listevariations=".$listevariations;
